...
<div class="Management-projects-i-layout layout">
    <i-layout :default-collapsed="false">
        <i-sider class="layout-sider" ref="side1" hide-trigger collapsible :collapsed-width="50" v-model="isCollapsed">
            <i-menu class="layout-sider-menu" :active-name="activeIndex" theme="light" width="auto" :class="menuitemClasses" :open-names="['1','2','3']">
                            ...
                            <i-poptip class="mypiptip" v-show="!collpsed" trigger="hover" :transfer="true" placement="right-start">
                                ...
                                <div slot="content">
                                    <i-menuItem class="sidebar-item" v-show="!collpsed" name="1-1">
                                        <router-link :to="'/Project/'+ (currentProject) + '/Article'">文章管理</router-link>
                                    </i-menuItem>
                                </div>
                            </i-poptip>
                            <el-icon v-show="collpsed" class="el-icon-s-management"></el-icon>
                            <span v-show="collpsed">文章资源管理</span>
                        </span>
                    </template>
                    <i-menuItem class="sidebar-item" v-show="collpsed" name="1-1">
                        <router-link :to="'/Project/'+ (currentProject) + '/Article'">文章管理</router-link>
                ...
                <i-submenu class="layout-sider-menu-title" name="2">
                    <template slot="title">
                        <span>
                            <i-poptip class="mypiptip" v-show="!collpsed" trigger="hover" :transfer="true" placement="right-start">
                                <el-icon class="el-icon-s-management"></el-icon>
                                <div slot="content">
                                    <i-menuItem class="sidebar-item" v-show="!collpsed" name="2-1">
                                        <router-link :to="'/Project/'+ (currentProject) + '/Video'">视频管理</router-link>
                                    </i-menuItem>
                                </div>
                            </i-poptip>
                            <el-icon v-show="collpsed" class="el-icon-s-management"></el-icon>
                            <span v-show="collpsed">视频资源管理</span>
                        </span>
                    </template>
                    <i-menuItem class="sidebar-item" v-show="collpsed" name="2-1">
                        <router-link :to="'/Project/'+ (currentProject) + '/Video'">视频管理</router-link>
                ...
                <i-submenu class="layout-sider-menu-title" name="3">
                    <template slot="title">
                        <span>
                            <i-poptip class="mypiptip" v-show="!collpsed" trigger="hover" :transfer="true" placement="right-start">
                                <el-icon class="el-icon-s-management"></el-icon>
                                <div slot="content">
                                    <i-menuItem class="sidebar-item" v-show="!collpsed" name="3-1">
                                        <router-link :to="'/Project/'+ (currentProject) + '/Tag'">标签管理</router-link>
                                    </i-menuItem>
                                </div>
                            </i-poptip>
                            <el-icon v-show="collpsed" class="el-icon-s-management"></el-icon>
                            <span v-show="collpsed">标签管理</span>
                        </span>
                    </template>
                    <i-menuItem class="sidebar-item" v-show="collpsed" name="3-1">
                        <router-link :to="'/Project/'+ (currentProject) + '/Tag'">标签管理</router-link>
...
export default {
    ...
    computed: {
        ...mapState(['collpsed', 'currentProject']),
        rotateIcon() {
            return [
                'menu-icon',
